    ...
    class FakeLLM:
        ...
        def with_structured_output(self, schema):
            ...
            if name == "TriageDecision":
                ...
                return FakeRunnable(g.TriageDecision(
...
async def test_input_guardrail():
    ...
    state = {
        "tenant_id": "tenant-001", "vessel_id": "vessel-001", "vessel_class": "Aframax",
        "thread_id": "thread-eval-ig", "engineer_id": "engineer-001",
...
async def test_output_guardrail():
    ...
    state = {
        "tenant_id": "tenant-001", "vessel_id": "vessel-001", "vessel_class": "Aframax",
        "thread_id": "thread-eval-og", "engineer_id": "engineer-001",
    ...
    class TriageCargoPump:
        ...
        def with_structured_output(self, schema):
            return FakeRunnable(g.TriageDecision(
                ...
                needs_telemetry=True, needs_compliance_lookup=False, needs_historical_rag=False,
                needs_weather_voyage=False, needs_maps=False, confidence=0.9,
...
async def test_advanced_rag():
    ...
    state = {
        "tenant_id": "tenant-001", "vessel_id": "vessel-001", "vessel_class": "Aframax",
        "thread_id": "thread-eval-rag", "engineer_id": "engineer-001",
...
async def test_cemg_avoidance():
    ...
    class TriageFailedTelemetry:
        ...
        def with_structured_output(self, schema):
            return FakeRunnable(g.TriageDecision(
                interaction_type="diagnostic", urgency="elevated", equipment_hint="Failed Telemetry Pump",
                needs_telemetry=True, needs_compliance_lookup=False, needs_historical_rag=False,
                needs_weather_voyage=False, needs_maps=False, confidence=0.9,
    ...
    state = {
        "tenant_id": "tenant-001", "vessel_id": "vessel-001", "vessel_class": "Aframax",
        "thread_id": "thread-eval-cemg-1", "engineer_id": "engineer-001",
    ...
    state_2 = {
        "tenant_id": "tenant-001", "vessel_id": "vessel-001", "vessel_class": "Aframax",
        "thread_id": "thread-eval-cemg-2", "engineer_id": "engineer-001",
